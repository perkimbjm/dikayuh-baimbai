...
<html lang="en">
  <head>
    ...
    <title>Form Verifikasi Pokir</title>
  ...
  <body class="bg-dark">
    <div class="container mt-2 mb-2">
      <section class="content">
        <div class="row">
          <div class="col-12">
            <form name="verif-pokir">
              <div class="card shadow" id="datalokasiobjek">
                <div class="card-header">
                  <div class="alert alert-primary text-center">
                    <h2>SURVEI VERIFIKASI POKIR</h2>Silahkan tambahkan data objek<hr>
                  ...
                  <div class="alert alert-success alert-dismissible fade show d-none my-alert3" role="alert">
                ...
                <div class="card-body overflow-auto">
                  ...
                  <div class="row">
                    <div class="col-sm">
                      <div class="form-group">
                        <label for="pengusul"><strong>Nama Anggota DPRD</strong></label>
                ...
                <div class="card-footer text-right">
                  <button type="submit" class="btn btn-primary btn-simpan3" id="btnSave"><i class="fas fa-save"></i> Simpan</button>
                  <div class="mt-3 mb-3 text-left">Developed by DPRKP Banjarmasin</div>
                  <br>
                  <button class="btn btn-primary btn-loading3 d-none" type="button" disabled>
